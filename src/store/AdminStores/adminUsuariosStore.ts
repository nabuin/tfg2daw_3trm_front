...
export const useAdminStore = defineStore('admin', {
  ...
  actions: {
    ...
    async obtenerTodosLosUsuarios() {
      try {
        // esto apuntara correctamente a https://coworking.jblas.me/api/usuarios
    ...
    async agregarUsuario(nuevoUsuario: Partial<Usuario>) {
      try {
        ...
        // y creara la url como https://coworking.jblas.me/auth/register
    ...
    async actualizarUsuario(idUsuario: number, datosUsuario: Partial<Usuario>) {
      try {
        // esto apuntara correctamente a https://coworking.jblas.me/api/usuarios/{idUsuario}
    ...
    async obtenerTodosLosRoles() {
      try {
        //  https://coworking.jblas.me/api/roles
